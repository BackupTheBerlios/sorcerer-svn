...
with source  stable http://tesseract-ocr.googlecode.com/files/tesseract-ocr-$VERSION.isl.tar.gz
with info    home http://code.google.com/p/tesseract-ocr
with info    vurl http://code.google.com/p/tesseract-ocr/downloads/list
with info    cite 'Icelandic language data files for tesseract-ocr'
