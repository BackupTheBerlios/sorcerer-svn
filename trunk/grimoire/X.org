  ...
  CATEGORY="xserver"
 ATTRIBUTE="core solo x11 invalid new"
...
build() {
  ...
  symlink_install()  {
    ...
    rm     -f  /usr/X11R6/lib{,64}/libz.a
		cp -Rp  /usr/X11R6/include/* /usr/include
    rm -rf  /usr/X11R6/include
    ls -fs ../include /usr/X11R6/include
  ...
  INCDIR=$( LC_ALL="C"; gcc -print-search-dirs | grep "^install: " | sed "s/install: //" )
