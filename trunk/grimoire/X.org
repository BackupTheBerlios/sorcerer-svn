   VERSION=( "R6.9.0" "R6.8.2" "R6.8.1" "R6.7.0" )
  CATEGORY="xserver"
 ATTRIBUTE="solo x11 depreciated"
  ...
  EPROVIDE="x11"
case  $VERSION  in
  R6.8.2)  USE_GCC="gcc-v3.4"  ;;
esac
       REQ=( "Xfenc Xfnts bison expat flex freetype libpng ncurses perl fontconfig"
 ...
 CONFLICTS="XFree86 X.org x11"
  ...
  ESTIMATE="53748"
      DESC="X.org spell is obsolete.  Please cast xf86 instead."
